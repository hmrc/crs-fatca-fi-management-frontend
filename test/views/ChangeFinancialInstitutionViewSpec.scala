...
class ChangeFinancialInstitutionViewSpec extends SpecBase with GuiceOneAppPerSuite with Injecting with ViewHelper {

  val view1: ChangeFinancialInstitutionView                             = app.injector.instanceOf[ChangeFinancialInstitutionView]
  ...
  "ChangeFinancialInstitutionView" - {
    "should render page components" in {
      ...
      val renderedHtml: HtmlFormat.Appendable = view1(true, "testFIName", financialInstitutionList, firstContactList, secondContactList)
