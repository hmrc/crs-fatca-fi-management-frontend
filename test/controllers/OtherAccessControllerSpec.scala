...
class OtherAccessControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val otherAccessRoute = routes.OtherAccessController.onPageLoad(NormalMode).url
  ...
  "OtherAccess Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(OtherAccessPage, true).success.value
