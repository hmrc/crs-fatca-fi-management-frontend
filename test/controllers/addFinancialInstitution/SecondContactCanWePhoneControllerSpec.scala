...
import pages.addFinancialInstitution.{NameOfFinancialInstitutionPage, SecondContactCanWePhonePage, SecondContactNamePage}
...
class SecondContactCanWePhoneControllerSpec extends SpecBase with MockitoSugar {
  ...
  val formProvider = new SecondContactCanWePhoneFormProvider()
  val form         = formProvider()

  lazy val secondContactCanWePhoneRoute = routes.SecondContactCanWePhoneController.onPageLoad(NormalMode).url

  "SecondContactCanWePhone Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(form, NormalMode, fiName, SecondContactName)(request, messages(application)).toString
      }
    }
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(boundForm, NormalMode, fiName, SecondContactName)(request, messages(application)).toString
      }
    }
