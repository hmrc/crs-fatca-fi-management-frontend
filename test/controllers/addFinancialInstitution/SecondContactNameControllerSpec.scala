...
import pages.addFinancialInstitution.{NameOfFinancialInstitutionPage, SecondContactNamePage}
...
class SecondContactNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  "SecondContactName Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = ua.set(SecondContactNamePage, "answer").success.value
