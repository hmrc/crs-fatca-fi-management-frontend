...
class IsThisTheBusinessNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val isThisTheBusinessNameRoute = controllers.addFinancialInstitution.registeredBusiness.routes.IsThisTheBusinessNameController.onPageLoad(NormalMode).url
