...
import forms.HaveUniqueTaxpayerReferenceFormProvider
...
import views.html.HaveUniqueTaxpayerReferenceView

import scala.concurrent.Future

class HaveUniqueTaxpayerReferenceControllerSpec extends SpecBase with MockitoSugar {
  ...
  "HaveUniqueTaxpayerReference Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(HaveUniqueTaxpayerReferencePage, true).success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, haveUniqueTaxpayerReferenceRoute)
