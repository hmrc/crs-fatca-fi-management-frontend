...
import pages.addFinancialInstitution.SendReportsPage
    ...
    answers.get(SendReportsPage).map {
      answer =>
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            accessibleActionItem("site.change", controllers.addFinancialInstitution.routes.SendReportsController.onPageLoad(CheckMode).url)
